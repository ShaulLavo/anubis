		...
		<div class="h-full flex flex-col p-2">
			<div class="text-muted-foreground text-center py-8">
				...
				<p class="text-xs">
					...
					<br />
					Use <code class="bg-muted px-1 rounded">startGlobalTrace()</code>,{' '}
					<code class="bg-muted px-1 rounded">markGlobalTrace()</code>, and{' '}
					<code class="bg-muted px-1 rounded">endGlobalTrace()</code> to track
